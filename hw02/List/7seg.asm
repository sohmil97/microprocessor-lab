...
; 0000 0015     if (selectedSeg >= 4)
	LDS  R26,_selectedSeg_G000
	LDS  R27,_selectedSeg_G000+1
	SBIW R26,4
	BRLT _0x4
; 0000 0016         selectedSeg = 0;
	LDI  R30,LOW(0)
	STS  _selectedSeg_G000,R30
	STS  _selectedSeg_G000+1,R30
; 0000 0017     PORTC = 0x0F & ~(1 << selectedSeg);
_0x4:
	LDS  R30,_selectedSeg_G000
	LDI  R26,LOW(1)
	CALL __LSLB12
	COM  R30
	ANDI R30,LOW(0xF)
...
; 0000 0018     PORTD = bcd_encode[count[selectedSeg]];
	LDS  R30,_selectedSeg_G000
	LDS  R31,_selectedSeg_G000+1
	SUBI R30,LOW(-_count)
	SBCI R31,HIGH(-_count)
	LD   R30,Z
	LDI  R31,0
	SUBI R30,LOW(-_bcd_encode)
	SBCI R31,HIGH(-_bcd_encode)
	LD   R30,Z
	OUT  0x12,R30
; 0000 0019     selectedSeg++;
	LDI  R26,LOW(_selectedSeg_G000)
	LDI  R27,HIGH(_selectedSeg_G000)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
